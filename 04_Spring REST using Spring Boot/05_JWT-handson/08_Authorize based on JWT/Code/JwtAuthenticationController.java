// Example: This file will exist but won't be mapped by SecurityConfig
// so it won't interfere with the new AuthenticationController
...
@RestController
@CrossOrigin
public class JwtAuthenticationController { // This controller's /authenticate endpoint will NOT be used by SecurityConfig
